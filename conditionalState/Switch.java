...
public class  Switch {
    ...
    public static void main(String[] args){
        ...
        switch(id){
            case 1:System.out.println("suraj kumar verma");
                    break;
            case 2:System.out.println("ojaswat dixit");
                    break;
            case 3:System.out.println("vikas dewangan");
                  switch(branch){
                    ...
                    case "AI" :System.out.println("AI Department");
                                break;
                    case "DS" :System.out.println("DS Department");
                                break;
                    default : System.out.println("department not mentioned");            
                  }
            default: System.out.println("enter the valid id of the student");      
        }
